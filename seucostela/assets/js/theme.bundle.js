(() => {
    var e, t = {
        ...
        373: () => {
            ...
            e && (["load", "scroll"].forEach((function (t) {
        ...
        331: (e, t, n) => {
            ...
            function c(e) {
                const t = document.getElementById("notification")
                    , n = new o.FN(t);
                t.querySelector(".toast-body").innerHTML = e,
                    n.show()
            }
            const d = document.getElementById("contactForm");
            (0,
                s.S1)("user_8uiTkB3w9DpexWtnUrnlx"),
                d && d.addEventListener("submit", (function (e) {
                    ...
                    t.disabled = !0,
                        ...
                        (0,
                            s.qm)("touche_service", "touche_contact_template", this).then((function () {
            ...
            var b = n(878);
            const m = document.querySelectorAll("[data-jarallax], [data-jarallax-element], [data-jarallax-video]");
            (0,
                b.jarallaxVideo)(),
                (0,
                    b.jarallaxElement)(),
                (0,
                    b.jarallax)(m),
                window.jarallax = b.jarallax,
                window.jarallaxElement = b.jarallaxElement,
                window.jarallaxVideo = b.jarallaxVideo;
            var h = n(820)
                , y = n.n(h);
            ...
            g.forEach((e => {
                ...
                y().accessToken = "pk.eyJ1Ijoic2ltcGxlcW9kZSIsImEiOiJja3Ewdm1qbzEwODd3MnZxbmZzaWR5dHU2In0.q3bYWUrysBloAAk10U0G6A";
                var n = new (y().Map)(t);
            ...
            (0,
                s.S1)("user_8uiTkB3w9DpexWtnUrnlx"),
                x && x.addEventListener("submit", (function (e) {
                    e.preventDefault();
                    const t = x.querySelector('[type="submit"]');
                    t.disabled = !0,
                        this.contact_number.value = 1e5 * Math.random() | 0,
                        (0,
                            s.qm)("touche_service", "touche_res_template", this).then((function () {
            ...
            if (!n) {
                ...
                for (c = 0; c < e.length; c++) {
                    for (var [n, a, r] = e[c], i = !0, s = 0; s < n.length; s++)
                        (!1 & r || l >= r) && Object.keys(o.O).every((e => o.O[e](n[s]))) ? n.splice(s--, 1) : (i = !1,
                            r < l && (l = r));
                    i && (e.splice(c--, 1),
                        t = a())
                }
